class DifferentialEquation(theano.Op):
    ...
    def __init__(self, func, times, *, n_visible_states, n_hidden_states, n_theta, t0=0):
        ...
        self.n_visible_states = n_visible_states
        self.n_states = n_visible_states + n_hidden_states
        self.n_hidden_states = n_hidden_states
        self.n_theta = n_theta
        self.n_p = n_states + n_hidden_states + n_theta
